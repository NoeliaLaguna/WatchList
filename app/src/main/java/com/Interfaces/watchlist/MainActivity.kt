    ...
    fun Navegacion() {
        ...
        val peliculas = remember {
            mutableStateListOf(
                ...
                Pelicula(2, "Interstellar", "Ciencia ficción", 2014, 8.6, false,  R.drawable.interstellar),
                Pelicula(3, "La Vida es Bella", "Bélico/Comedia", 1997, 9.7, true,  R.drawable.lavidaesbella),
